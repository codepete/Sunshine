...
public class WeatherProvider extends ContentProvider {
    ...
    static{
        ...
        //sets the "FROM" in a sqlite query
    ...
    private void normalizeLocation(ContentValues values) {
        if (values.containsKey(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING)) {
            String locationValue = values.getAsString(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING);
            values.put(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING, locationValue);
        }
    }
